...
def banner():
    ...
    art = r"""
       _____ ______ ______ __  ___ __  __ ______      _____ _____  __   __
      / ___// ____// ____//  |/  // / / // ____/     / ___// __ \ \ \ / /
      \__ \/ __/  / __/  / /|_/ // /_/ // __/        \__ \/ /_/ /  \ V /
     ___/ / /___ / /___ / /  / // __  // /___       ___/ / _, _/    | |
    /____/_____//_____//_/  /_//_/ /_//_____/      /____/_/ |_|     |_|
    """
    utils.print(f'{G}{art}{W}\n')
    utils.print(f'{G}[>] {C}Created By   : {W}𒉭 ᎠᴀʀᴋㅤᏙᴇɴᴏᴍㅤ×͜× | 𝐓𝐇𝐄 𝐀𝐋𝐏𝐇𝐀 𒉭')
