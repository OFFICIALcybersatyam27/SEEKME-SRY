...
<p>
  <a style="margin-right: 10px;" href="https://github.com/OFFICIALcybersatyam27/SEEKME-SRY#installation">
    <img src="https://dabuttonfactory.com/button.png?t=INSTALL&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
  <a style="margin-right: 10px;" href="https://github.com/OFFICIALcybersatyam27/SEEKME-SRY#usage">
    <img src="https://dabuttonfactory.com/button.png?t=USAGE&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
  <a href="https://github.com/OFFICIALcybersatyam27/SEEKME-SRY#demo">
    <img src="https://dabuttonfactory.com/button.png?t=DEMO&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
</p>

Concept behind Seeker is simple, just like we host phishing pages to get credentials why not host a fake page that requests your location like many popular location based websites. Read more on <a/> 𒉭 ᎠᴀʀᴋㅤᏙᴇɴᴏᴍ | 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 Blog </a>.Seeker Hosts a fake website which asks for Location Permission and if the target allows it, we can get :
...
* Google reCAPTCHA (Made by 𒉭 ᎠᴀʀᴋㅤᏙᴇɴᴏᴍ | 𝐄𝐌𝐏𝐄𝐑𝐎𝐑)
...
```bash
git clone https://github.com/OFFICIALcybersatyam27/SEEKME-SRY.git
cd SEEKME-SRY
chmod +x install.sh
./install.sh
```
...
```bash
sudo pacman -S SEEKME-SRY
```

### Docker

```bash
docker pull 𒉭 ᎠᴀʀᴋㅤᏙᴇɴᴏᴍㅤ×͜× | 𝐓𝐇𝐄 𝐀𝐋𝐏𝐇𝐀 𒉭/SEEKME-SRY
```
